 ...
 * @see SystemUiHider
 */
public class HintFullscreenActivity extends Activity {
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hint_fullscreen);
		...
		hintTextView.setText(hint.getHintContent());
		ImageView imageView = (ImageView) findViewById(R.id.hintImageView);
		imageView.setImageResource(hint.getImageLocation());
	}
